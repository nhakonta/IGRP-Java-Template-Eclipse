...
public class Param_estrutura_verticalView extends View {
	...
	public Param_estrutura_verticalView(){

		this.setPageTitle("Param Estrutura Vertical");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_estrutura_vertical","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_2ed7_bdfd").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_estrutura_vertical","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_cf4b_dd70").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_estrutura_vertical","eliminar","confirm","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_0028_75c5").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_estrutura_vertical) model).getTable_1());
		}
}
