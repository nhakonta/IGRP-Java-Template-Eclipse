...
public class Param_caixalhariasView extends View {
	...
	public Param_caixalhariasView(){

		this.setPageTitle("Param Caixalharias");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_caixalharias","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_710b_194c").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_caixalharias","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_7cb0_52e8").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_caixalharias","eliminar","confirm","primary|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_edcd_3a39").add("type","specific").add("class","primary").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_caixalharias) model).getTable_1());
		}
}
