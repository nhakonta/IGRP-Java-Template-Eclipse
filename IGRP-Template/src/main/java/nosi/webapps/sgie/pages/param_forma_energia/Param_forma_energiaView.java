...
public class Param_forma_energiaView extends View {
	...
	public Param_forma_energiaView(){

		this.setPageTitle("Param Forma Energia");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_forma_energia","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_fecb_21e9").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_forma_energia","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_c45b_f299").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_forma_energia","eliminar","confirm","primary|fa-trash-o","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_forma_energia) model).getTable_1());
		}
}
