...
public class Param_acesso_internetView extends View {
	...
	public Param_acesso_internetView(){

		this.setPageTitle("Param Acesso Internet");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_acesso_internet","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_fecb_21e9").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_acesso_internet","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_c45b_f299").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_acesso_internet","eliminar","confirm","primary|fa-trash-o","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_acesso_internet) model).getTable_1());
		}
}
