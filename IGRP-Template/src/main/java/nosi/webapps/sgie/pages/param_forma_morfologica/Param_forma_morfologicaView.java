...
public class Param_forma_morfologicaView extends View {
	...
	public Param_forma_morfologicaView(){

		this.setPageTitle("Param Forma Morfológica");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_forma_morfologica","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_41db_b8bc").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_forma_morfologica","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_3d9a_f204").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_forma_morfologica","eliminar","confirm","primary|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_0b0f_6344").add("type","specific").add("class","primary").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_forma_morfologica) model).getTable_1());
		}
}
