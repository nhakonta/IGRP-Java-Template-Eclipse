...
public class Param_formas_acesso_escolaView extends View {
	...
	public Param_formas_acesso_escolaView(){

		this.setPageTitle("Param Formas Acesso Escola");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_formas_acesso_escola","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_ff93_5001").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_formas_acesso_escola","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_df78_2566").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_formas_acesso_escola","eliminar","confirm","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_b307_4784").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_formas_acesso_escola) model).getTable_1());
		}
}
