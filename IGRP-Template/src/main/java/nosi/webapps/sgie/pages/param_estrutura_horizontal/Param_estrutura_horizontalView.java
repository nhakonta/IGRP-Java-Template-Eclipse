...
public class Param_estrutura_horizontalView extends View {
	...
	public Param_estrutura_horizontalView(){

		this.setPageTitle("Param Estrutura Horizontal");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_estrutura_horizontal","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_f733_be68").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_estrutura_horizontal","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_69f1_3e93").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_estrutura_horizontal","eliminar","confirm","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_2f44_7f5d").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_estrutura_horizontal) model).getTable_1());
		}
}
