...
public class Param_fundacoesView extends View {
	...
	public Param_fundacoesView(){

		this.setPageTitle("Param Fundações");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_fundacoes","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_2b3f_9258").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_fundacoes","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_8c15_3816").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_fundacoes","eliminar","confirm","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_9fe8_f14f").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_fundacoes) model).getTable_1());
		}
}
