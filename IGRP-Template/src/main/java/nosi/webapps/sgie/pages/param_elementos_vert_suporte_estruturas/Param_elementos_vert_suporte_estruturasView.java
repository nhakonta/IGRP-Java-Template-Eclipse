...
public class Param_elementos_vert_suporte_estruturasView extends View {
	...
	public Param_elementos_vert_suporte_estruturasView(){

		this.setPageTitle("Param Elementos Vert Suporte Estruturas");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_elementos_vert_suporte_estruturas","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_1c07_282f").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_elementos_vert_suporte_estruturas","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_b5fc_af0c").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_elementos_vert_suporte_estruturas","eliminar","_blank","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_8c72_4764").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_elementos_vert_suporte_estruturas) model).getTable_1());
		}
}
