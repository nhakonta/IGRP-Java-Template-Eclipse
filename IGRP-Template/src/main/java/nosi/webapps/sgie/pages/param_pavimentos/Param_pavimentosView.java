...
public class Param_pavimentosView extends View {
	...
	public Param_pavimentosView(){

		this.setPageTitle("Param Pavimentos");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_pavimentos","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_5df4_302a").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_pavimentos","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_7d1a_8f3e").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_pavimentos","eliminar","confirm","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_317e_32fb").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_pavimentos) model).getTable_1());
		}
}
