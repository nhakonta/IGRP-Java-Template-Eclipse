...
public class Folha_avaliacao_wcController extends Controller {
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		Folha_avaliacao_wc model = new Folha_avaliacao_wc();
		model.load();
		Folha_avaliacao_wcView view = new Folha_avaliacao_wcView();
		/*----#gen-example
		  EXAMPLES COPY/PASTE:
	...
	TblAuxSimNao tblauxsimnaofilter = new TblAuxSimNao().find();
	List<TblAuxSimNao> tblauxsimnaoList = tblauxsimnaofilter.all();
	LinkedHashMap<String, String> abastecimento_por_privados = new LinkedHashMap<>();
	for(TblAuxSimNao tblauxsimnao : tblauxsimnaoList){
		abastecimento_por_privados.put(tblauxsimnao.getId().toString(), gt(tblauxsimnao.getDescricao()));
	}
	view.abastecimento_por_privados.setValue(abastecimento_por_privados);
	}catch ( Exception e ) {
		e.printStackTrace();
	}
	...
	TblAuxSimNao tblauxsimnaofilter = new TblAuxSimNao().find();
	List<TblAuxSimNao> tblauxsimnaoList = tblauxsimnaofilter.all();
	LinkedHashMap<String, String> dispositivos_de_seguranca = new LinkedHashMap<>();
	for(TblAuxSimNao tblauxsimnao : tblauxsimnaoList){
		dispositivos_de_seguranca.put(tblauxsimnao.getId().toString(), gt(tblauxsimnao.getDescricao()));
	}
	view.dispositivos_de_seguranca.setValue(dispositivos_de_seguranca);
	}catch ( Exception e ) {
		e.printStackTrace();
	}
	...
	TblAuxSimNao tblauxsimnaofilter = new TblAuxSimNao().find();
	List<TblAuxSimNao> tblauxsimnaoList = tblauxsimnaofilter.all();
	LinkedHashMap<String, String> torneiras_funcionais = new LinkedHashMap<>();
	for(TblAuxSimNao tblauxsimnao : tblauxsimnaoList){
		torneiras_funcionais.put(tblauxsimnao.getId().toString(), gt(tblauxsimnao.getDescricao()));
	}
	view.torneiras_funcionais.setValue(torneiras_funcionais);
	}catch ( Exception e ) {
		e.printStackTrace();
	}
	...
	TblAuxSimNao tblauxsimnaofilter = new TblAuxSimNao().find();
	List<TblAuxSimNao> tblauxsimnaoList = tblauxsimnaofilter.all();
	LinkedHashMap<String, String> valvulas_funcionais = new LinkedHashMap<>();
	for(TblAuxSimNao tblauxsimnao : tblauxsimnaoList){
		valvulas_funcionais.put(tblauxsimnao.getId().toString(), gt(tblauxsimnao.getDescricao()));
	}
	view.valvulas_funcionais.setValue(valvulas_funcionais);
	}catch ( Exception e ) {
		e.printStackTrace();
	}
