...
public class Param_entrada_morfoView extends View {
	...
	public Param_entrada_morfoView(){

		this.setPageTitle("Param Entrada Morfológica");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_entrada_morfo","guardar","submit_form","primary|fa-chevron-down","","");
		btn_guardar.propertie.add("id","button_0410_041e").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_entrada_morfo","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_6130_d97f").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_entrada_morfo","eliminar","_blank","danger|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_d13c_6bc8").add("type","specific").add("class","danger").add("rel","eliminar").add("refresh_components","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_entrada_morfo) model).getTable_1());
		}
}
