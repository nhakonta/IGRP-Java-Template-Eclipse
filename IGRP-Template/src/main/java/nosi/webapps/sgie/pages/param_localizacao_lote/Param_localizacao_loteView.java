...
public class Param_localizacao_loteView extends View {
	...
	public Param_localizacao_loteView(){

		this.setPageTitle("Param Localização Lote");
		...
		btn_guardar = new IGRPButton("Guardar","sgie","Param_localizacao_lote","guardar","submit_form","primary|fa-check","","");
		btn_guardar.propertie.add("id","button_b476_c2e7").add("type","form").add("class","primary").add("rel","guardar").add("refresh_components","");

		btn_editar = new IGRPButton("Editar","sgie","Param_localizacao_lote","editar","mpsubmit","warning|fa-edit","","");
		btn_editar.propertie.add("id","button_8581_a9c8").add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","sgie","Param_localizacao_lote","eliminar","confirm","primary|fa-trash-o","","");
		btn_eliminar.propertie.add("id","button_e6c8_0e68").add("type","specific").add("class","primary").add("rel","eliminar").add("refresh_components","").add("labelConfirm","Deseja realmente realizar esta operação?");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Param_localizacao_lote) model).getTable_1());
		}
}
